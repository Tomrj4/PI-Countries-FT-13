...
function Form() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        if (formValue.name === "" || formValue.duration === "---" || formValue.difficulty === "---" || formValue.season === "---" || selectedCountries.length === 0) {
                    ...
                    <div className={styles.InputConteiner}>
                        ...
                        <div className={styles.DivMain}>
                            ...
                            <div>
                                ...
                                <select className={styles.Input} name="duration" onChange={handleChange} >
                                    <option >---</option>
                                    <option>1Hs</option>
                                    <option>2Hs</option>
                                    <option>3Hs</option>
                            ...
                            <div>
                                ...
                                <select className={styles.Input} type="number" name="difficulty" onChange={handleChange}>
                                    <option>---</option>
                            ...
                            <div>
                                ...
                                <select className={styles.Input} type="text" name="season" onChange={handleChange}>
                                    <option>---</option>
